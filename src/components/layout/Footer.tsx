      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              <Image
                ...
                height={40}
              />
              <span className="text-white font-semibold text-lg">JobSearch</span>
            </div>
          ...
          <div className="lg:col-span-3 grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="/search" className="text-sm hover:text-white transition-colors">Job Search</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="https://github.com/ChanMeng666" target="_blank" rel="noopener noreferrer" className="text-sm hover:text-white transition-colors">Blog</a></li>
                <li><a href="mailto:chanmeng.dev@gmail.com" className="text-sm hover:text-white transition-colors">Contact</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="/api-docs" className="text-sm hover:text-white transition-colors">Documentation</Link></li>
                <li><Link href="/api-docs#examples" className="text-sm hover:text-white transition-colors">Code Examples</Link></li>
                <li><Link href="/#faq" className="text-sm hover:text-white transition-colors">FAQ</Link></li>
                <li><a href="https://github.com/ChanMeng666/linkedin-jobs-search" target="_blank" rel="noopener noreferrer" className="text-sm hover:text-white transition-colors">GitHub</a></li>
              </ul>
            </div>
        ...
        <div className="pt-8 border-t border-stone-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex flex-col md:flex-row items-center gap-4 text-sm">
            <p>© {currentYear} JobSearch. All rights reserved.</p>
            <div className="flex items-center gap-2">
              ...
              />
              <span>Built by <strong className="text-white">Chan Meng</strong></span>
            </div>
          </div>

          <a
            href="mailto:chanmeng.dev@gmail.com?subject=Custom%20Website%20Development%20Inquiry"
            className="inline-flex items-center gap-2 px-4 py-2 bg-brand-primary text-white rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors"
          >
